...
export default function Navbar() {
  ...
  return (
    <>
      <nav className="sticky top-0 z-50 border-b border-white/[0.08] bg-[#060912]/80 backdrop-blur-xl">
        ...
        {/* Mobile menu */}
        {menuOpen && (
          <div className="lg:hidden border-t border-white/[0.08] bg-[#060912]/95 backdrop-blur-2xl px-4 py-3 flex flex-col gap-1">
            {NAV_LINKS.map((link) => {
              const active = pathname === link.href;
              return (
                <Link
